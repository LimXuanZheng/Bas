...
/**
 * Servlet implementation class teacherSharing3
 */
@WebServlet("/teacherSharing3")
public class teacherSharing3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(
				"</div>"
						...
						+					"<a href='teacherSharing2'><button class='button' id='lastOne' onclick='refreshpage()'>Shared With Me</button></a>"
						+				"</div>"
